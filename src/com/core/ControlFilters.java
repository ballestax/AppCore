...
import static com.core.MyConstants.FILTER_BOOL_DIFFERENT;
import static com.core.MyConstants.FILTER_BOOL_EQUAL;
import static com.core.MyConstants.FILTER_NUM_DIFFERENT;
import static com.core.MyConstants.FILTER_NUM_EQUALS;
import static com.core.MyConstants.FILTER_NUM_GREATER;
import static com.core.MyConstants.FILTER_NUM_GREATER_EQUAL;
import static com.core.MyConstants.FILTER_NUM_LESS;
import static com.core.MyConstants.FILTER_NUM_LESS_EQUAL;
import static com.core.MyConstants.FILTER_TEXT_CONTAINS;
import static com.core.MyConstants.FILTER_TEXT_EQUALS;
import static com.core.MyConstants.FILTER_TEXT_START;
import static com.core.MyConstants.FILTROS_BOOLEANOS;
import static com.core.MyConstants.FILTROS_NUMERO;
import static com.core.MyConstants.FILTROS_TEXTO;
...
public class ControlFilters {
    ...
    private void init() {
        ...
        Field direccion = new Field(Field.T_TEXT, "Responsable", "persons.address");
...
//        });
        ...
        M_FIELDS.put(tables[1], new Field[]{cedula, nombre1, nombre2, apellido1, apellido2,
            telefono, direccion, barrio, comuna, corregimiento, rancheria, puestoVot, mesaVot,
            zonVot, dep, mun, 
        });
...
//            zonVot, dep, mun, testigo, jurado, voluntario, compromiso, vehiculo, placa});
        ...
        FIELDS_DF_PERSONS = new Field[]{cedula, nombre1, nombre2, apellido1, apellido2, dep, mun, puestoVot, mesaVot};
//        FIELDS_DF_VEHICLES = new Field[]{cedula, nombre1, nombre2, apellido1, apellido2, dep, mun, puestoVot, barrio, vehiculo, placa};
        ...
        FIELDS_DF_COMMUNE = new Field[]{cedula, apellido1, apellido2, nombres, telefono,
            direccion, barrio, comuna, mun, dep, puestoVot, mesaVot};
