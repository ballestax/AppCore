 ...
 * @author ballestax
 */
public class PanelAdminModule extends javax.swing.JPanel {
     ...
     */
    public PanelAdminModule(Aplication app) {
    ...
    private void customInit() {
        ...
        addTab("Configuracion", app.getGuiManager().getPanelAdminConfig());
