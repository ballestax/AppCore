...
public class PanelNewUser extends PanelCaptura implements ActionListener {
    ...
    private void initComponents() {
        ...
        layout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {pass1, pass2, tfUser});
        ...
        layout.linkSize(javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {pass1, tfUser});
        ...
        if (AC_NEW_USER.equals(e.getActionCommand())) {
            ...
            if (L1 >= 4 || L2 >= 4) {
                if (String.valueOf(pass1.getPassword()).equals(String.valueOf(pass2.getPassword()))) {
                    pcs.firePropertyChange(AC_NEW_USER, tfUser.getText(), pass1.getPassword());
                    getRootPane().getParent().setVisible(false);
                } else {
                    JOptionPane.showMessageDialog(null, "Las contraseñas no coinciden");
                }
